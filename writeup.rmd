...
Our project explores data-related jobs on Indeed using `R`. A large part of our project is clustering jobs by their job descriptions. We obtained job descriptions from Indeed using webscrapping. To visualize our results we created a Shiny app.
...
We wanted to show common job descriptions and companies for each cluster in a table. This provides a better explantion of which jobs are associated with each cluster. We used data from our training set to create this table. 

<br>

## Conclusion

We created a Shiny app that explores clusters of jobs using data from Indeed. We webscraped the data, cleaned and transformed the data and displayed the cluster information with a word cloud and map of jobs. 
